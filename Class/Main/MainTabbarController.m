...
//    SecondViewController *tactics=[[SecondViewController alloc]init];
//    [self addChildViewController:tactics withTitle:@"理财产品" image:[UIImage imageNamed:@"tab_product_normal"] selectedImage:nil];
//    ThirdViewController *tools=[[ThirdViewController alloc]init];
//    [self addChildViewController:tools withTitle:@"我的账户" image:[UIImage imageNamed:@"tab_account_normal"] selectedImage:nil];
