...
+ (NSString *)timeIntervalFromLastTime:(NSString *)lastTime lastTimeFormat:(NSString *)format1 ToCurrentTime:(NSString *)currentTime currentTimeFormat:(NSString *)format2{
    ...
    return [CustomTool timeIntervalFromLastTime:lastDate ToCurrentTime:currentDate];
}
...
#pragma mark - Avilable in iOS 8.0 and later 毛玻璃效果
...
{
    NSMutableDictionary *paramet = [NSMutableDictionary dictionaryWithCapacity:0];
//    NSString *version = [[[NSBundle mainBundle] infoDictionary] objectForKey:@"CFBundleShortVersionString"];
//    [paramet setValue:@"ios" forKey:@"devicetype"];
//    [paramet setValue:@"10000" forKey:@"versioncode"];
//    [paramet setValue:GetUserID forKey:@"user_id"];
//    [paramet setValue:APPKEY forKey:@"appkey"];
//    [paramet setValue:[NSString stringWithFormat:@"%li",[CustomTool cTimestampFromDate]] forKey:@"ts"];
//    [paramet setValue:GetOauth_token  forKey:@"oauth_token"];
//    NSString *sign = [CustomTool md5:[NSString stringWithFormat:@"%@%li",APPSECRET,[CustomTool cTimestampFromDate]]];
//    [paramet setValue:[[CustomTool md5:[NSString stringWithFormat:@"%@%@",sign,APPKEY]] uppercaseString] forKey:@"signa"];
    return paramet;
}

#pragma mark - base64加密
+ (NSString*)encodeBase64String:(NSString * )input {
    NSData *baseData = [input dataUsingEncoding:NSUTF8StringEncoding];
 ...
 **/
#pragma mark - 生成二维码
+ (UIImage *)createRRcode:(NSString *)str
{
    //1.实例化一个滤镜
